...
<template>
  <svg class="icon icon-tabler icons-tabler-outline icon-tabler-gift-off" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
